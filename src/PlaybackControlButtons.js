...
class PlaybackControlButtons extends Component {
    render() {
      return (
        <div>
            <button title="like-track" className="PlaybackControlButtons__button"> <span role="img" aria-label="Like">&#x1F499;</span> </button>
            ...
            <button title="repeat" className="PlaybackControlButtons__button"> <span role="img" aria-label="Repeat">&#x1F501;</span> </button>
        </div>)
    }
}
